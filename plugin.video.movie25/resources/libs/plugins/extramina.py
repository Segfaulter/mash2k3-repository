...
def GENREEXTRA(murl):
        main.addDir('Action','http://www.extraminamovies.in/category/action-movies/',532,"%s/art/wfs/act.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Adventure','http://www.extraminamovies.in/category/adventure-movies/',532,"%s/art/wfs/adv.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Animation','http://www.extraminamovies.in/category/animation-movies/',532,"%s/art/wfs/ani.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Biography','http://www.extraminamovies.in/category/biography-movies/',532,"%s/art/wfs/bio.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Bollywood','http://www.extraminamovies.in/category/bollywood-movies/',532,"%s/art/wfs/bollyw.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Classics','http://www.extraminamovies.in/category/classic-movies/',532,"%s/art/wfs/class.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Comedy','http://www.extraminamovies.in/category/comedy-movies/',532,"%s/art/wfs/com.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Crime','http://www.extraminamovies.in/category/crime-movies/',532,"%s/art/wfs/cri.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Documentary','http://www.extraminamovies.in/category/documentary-movies/',532,"%s/art/wfs/doc.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Drama','http://www.extraminamovies.in/category/drama-movies/',532,"%s/art/wfs/dra.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Family','http://www.extraminamovies.in/category/family-movies/',532,"%s/art/wfs/fam.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Fantasy','http://www.extraminamovies.in/category/fantasy-movies/',532,"%s/art/wfs/fan.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Foreign','http://www.extraminamovies.in/category/foreign-movies/',532,"%s/art/wfs/foriegn.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Horror','http://www.extraminamovies.in/category/horror-movies/',532,"%s/art/wfs/hor.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Music','http://www.extraminamovies.in/category/music-movies/',532,"%s/art/wfs/mus.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Mystery','http://www.extraminamovies.in/category/mystery-movies/',532,"%s/art/wfs/mys.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Romance','http://www.extraminamovies.in/category/romance-movies/',532,"%s/art/wfs/rom.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Sci-Fi','http://www.extraminamovies.in/category/scifi-movies/',532,"%s/art/wfs/sci.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Sport','http://www.extraminamovies.in/category/sport-movies/',532,"%s/art/wfs/spo.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Thriller','http://www.extraminamovies.in/category/thriller-movies/',532,"%s/art/wfs/thr.png"%selfAddon.getAddonInfo("path"))
        main.addDir('War','http://www.extraminamovies.in/category/war-movies/',532,"%s/art/wfs/war.png"%selfAddon.getAddonInfo("path"))
        main.addDir('Western','http://www.extraminamovies.in/category/western-movies/',532,"%s/art/wfs/wes.png"%selfAddon.getAddonInfo("path"))
